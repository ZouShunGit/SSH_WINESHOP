			...
			<div align="center">
				<table width="631" border="0" cellspacing="10" cellpadding="0"
					...
					<tr>
						...
						<td width="410"><input type="text" name="scname" id="scname"
							class="yanseA" onblur="checkName()" style="font-size: 18px;" /><label id="name_init"></label></td>
					</tr>
					<tr>
						<td><div align="right">描述：</div></td>
						<td><textarea name="scdesc" id="scdesc"
					...
					<tr>
						<td colspan="2"><div align="center">
								<input type="reset" class="login" value="返回"
									...
									name="" type="reset" value="重置" class="login" /> <input
